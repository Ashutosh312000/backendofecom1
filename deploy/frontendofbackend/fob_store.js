window.addEventListener('DOMContentLoaded', () => {
    ...
    axios.get(`http://13.235.73.218:4000/`)
        .then((response) => {
            goto(response);
...
goto = (response) => {
    ...
    for (let i = 0; i < myarr.length; i++) {
        ...
        addToCartBtn.addEventListener('click', (e) => {
            ...
            axios.post(`http://13.235.73.218:4000/cart`, { productId: myarr[i].id })
                .then((response) => {
        ...
        //     axios.post(`http://13.235.73.218:4000/admin/delete-product`, { productId: myarr[i].id })
        //         .then((response) => {
        //             if (response.status == 200) {
    ...
    gotopage = (pagenumber) => {
        axios.get(`http://13.235.73.218:4000/?page=${pagenumber}`)
            .then((response) => {
                storeSection.remove();
                pagination.remove();
                goto(response)
    ...
    if (e.target.classList.contains('addToCartBtn')) {
        ...
        const totalprice = document.getElementById('totalprice');
                    ...
                    remove_btn.addEventListener('click', (e) => {
                        ...
                        axios.post('http://13.235.73.218:4000/cart-delete-item', { productId: albumid })
                            .then((response) => {
                                if (response.status != 200) {
